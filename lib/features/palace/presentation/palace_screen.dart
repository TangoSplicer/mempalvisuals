  ...
  Future<void> _handleFileAttachment() async {
    try {
      ...
      if (result != null && result.files.single.path != null) {
        ...
        ref.read(palaceControllerProvider.notifier).ingestDocument(filePath, fileName);
      }
    } catch (e) {
              ...
              child: Row(
                children: [
                  IconButton(
                    ...
                    onPressed: state.isExtracting ? null : _handleFileAttachment, // Disable while extracting
                  ),
                  Expanded(
                    child: TextField(
