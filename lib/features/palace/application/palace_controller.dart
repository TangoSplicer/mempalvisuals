...
class PalaceState {
  ...
  PalaceState({this.palaceId, this.messages = const [], this.isProcessing = false, this.isExtracting = false});
  PalaceState copyWith({int? palaceId, List<ChatMessage>? messages, bool? isProcessing, bool? isExtracting}) {
    return PalaceState(
...
class PalaceController extends StateNotifier<PalaceState> {
  ...
  void clearState() { state = PalaceState(); }
