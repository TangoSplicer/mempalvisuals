...
4. CRITICAL: Create DEEP HIERARCHIES and chains, not flat star-schemas. Do not connect everything to the main subject. 
   - BAD: [User]->[HMRC], [User]->[Civil Servant]
   - GOOD: [User]->WORKS_FOR->[HMRC]->HAS_ROLE->[Civil Servant]
...
EXPECTED OUTPUT FORMAT:
{
  ...
  "edges": [
    ...
    {"source": "hmrc_gov", "target": "civil_servant", "label": "HAS_ROLE"}
  ]
}
